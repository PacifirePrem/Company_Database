...
CREATE TABLE works_with (
 ...
 CREATE TABLE branch_supplier (
  ...
  -- Corporate
  INSERT INTO employee VALUES(100, 'Mark','Wolowitz','1972-07-18','M',250000,NULL,NULL);
  
  INSERT INTO branch VALUES(1, 'Corporate',100,'2008-06-21');
  
  UPDATE employee
  SET branch_id = 1
  WHERE emp_id = 100;
  
  INSERT INTO employee VALUES(101, 'Holoword','Cooper','1975-08-31','M',200000,100,1);
...
SELECT COUNT(super_id) FROM employee WHERE sex = 'F' AND birth_day > '1971-01-01';
...
SELECT employee.first_name, employee.last_name FROM employee WHERE employee.emp_id IN (SELECT works_with.emp_id FROM works_with WHERE works_with.total_sales > 50000);
